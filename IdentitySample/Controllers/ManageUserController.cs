...
using IdentitySample.ViewModel.ManageUser;
    ...
    public class ManageUserController : Controller
    {
        ...
        public async Task<IActionResult> RemoveUserFromRole(string id)
        {
            ...
            var validRoles = userRoles
                .Select(ur => new UserRolesViewModel(ur)).ToList();
            var model = new AddUserToRoleViewModel(id, validRoles);
        ...
        public async Task<IActionResult> AddUserToClaim(AddOrRemoveClaimViewModel model)
        {
            ...
            var requestClaims = model.UserClaims
                .Where(r => r.IsSelected)
                .Select(u => new Claim(u.ClaimType, true.ToString()))
                .ToList();
